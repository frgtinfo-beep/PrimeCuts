...
`),this.data.events.forEach(t=>e+=t.toString()),e+=f(this.data),e+=`END:VCALENDAR`,l(e)}ttl(e){return e===void 0?this.data.ttl:(g(e)?this.data.ttl=e.asSeconds():e&&e>0?this.data.ttl=e:this.data.ttl=null,this)}url(e){return e===void 0?this.data.url:(this.data.url=e||null,this)}x(e,t){if(e===void 0)return i(this.data);if(typeof e==`string`&&typeof t==`string`)i(this.data,e,t);else if(typeof e==`object`)i(this.data,e);else throw Error(`Either key or value is not a string!`);return this}};function G(e){return new W(e)}export{I as ICalAlarm,F as ICalAlarmRelatesTo,P as ICalAlarmType,N as ICalAttendee,k as ICalAttendeeRole,j as ICalAttendeeStatus,M as ICalAttendeeType,W as ICalCalendar,U as ICalCalendarMethod,L as ICalCategory,H as ICalEvent,R as ICalEventBusyStatus,z as ICalEventClass,e as ICalEventRepeatingFreq,B as ICalEventStatus,V as ICalEventTransparency,t as ICalEventTravelTimeSuggestion,n as ICalEventTravelTimeTransportation,r as ICalWeekday,G as default,c as escape,l as foldLines,u as formatDate,d as formatDateTZ};
