...
`).map(function(e){if(e.length<=74&&O(e))return e;let t=``,n=0;for(let r=0;r<e.length;r++){let i=e.charAt(r),a=e.charCodeAt(r),o;a<128?o=1:a<2048?o=2:a>=55296&&a<=56319?(i+=e.charAt(++r),o=4):o=3,n+=o,n>74&&(t+=`\r
 `,n=o),t+=i}return t}).join(`\r
...
`),this.data.events.forEach(t=>e+=t.toString()),e+=f(this.data),e+=`END:VCALENDAR`,l(e)}ttl(e){return e===void 0?this.data.ttl:(g(e)?this.data.ttl=e.asSeconds():e&&e>0?this.data.ttl=e:this.data.ttl=null,this)}url(e){return e===void 0?this.data.url:(this.data.url=e||null,this)}x(e,t){if(e===void 0)return i(this.data);if(typeof e==`string`&&typeof t==`string`)i(this.data,e,t);else if(typeof e==`object`)i(this.data,e);else throw Error(`Either key or value is not a string!`);return this}};function G(e){return new W(e)}exports.ICalAlarm=I,exports.ICalAlarmRelatesTo=F,exports.ICalAlarmType=P,exports.ICalAttendee=N,exports.ICalAttendeeRole=k,exports.ICalAttendeeStatus=j,exports.ICalAttendeeType=M,exports.ICalCalendar=W,exports.ICalCalendarMethod=U,exports.ICalCategory=L,exports.ICalEvent=H,exports.ICalEventBusyStatus=R,exports.ICalEventClass=z,exports.ICalEventRepeatingFreq=e,exports.ICalEventStatus=B,exports.ICalEventTransparency=V,exports.ICalEventTravelTimeSuggestion=t,exports.ICalEventTravelTimeTransportation=n,exports.ICalWeekday=r,exports.default=G,exports.escape=c,exports.foldLines=l,exports.formatDate=u,exports.formatDateTZ=d;
