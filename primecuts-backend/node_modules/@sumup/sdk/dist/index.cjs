...
class Checkouts extends APIResource {
    ...
    get(checkoutId, options) {
        return this._client.get({
            path: `/v0.1/checkouts/${checkoutId}`,
            ...options
        });
    }
    getWithResponse(checkoutId, options) {
        return this._client.getWithResponse({
            path: `/v0.1/checkouts/${checkoutId}`,
            ...options
        });
    }
    deactivate(checkoutId, options) {
        return this._client.delete({
            path: `/v0.1/checkouts/${checkoutId}`,
            ...options
        });
    }
    deactivateWithResponse(checkoutId, options) {
        return this._client.deleteWithResponse({
            path: `/v0.1/checkouts/${checkoutId}`,
            ...options
        });
    }
    update(checkoutId, body, options) {
    ...
    updateWithResponse(checkoutId, body, options) {
    ...
    createApplePaySession(checkoutId, body, options) {
    ...
    createApplePaySessionWithResponse(checkoutId, body, options) {
...
class Readers extends APIResource {
    createGoCheckout(merchantCode, readerId, body, options) {
        return this._client.post({
    ...
    createGoCheckoutWithResponse(merchantCode, readerId, body, options) {
        return this._client.postWithResponse({
            path: `/v0/merchants/${merchantCode}/readers/${readerId}/go-checkout`,
            body,
            ...options
    ...
    get(merchantCode, readerId, options) {
        return this._client.get({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            ...options
        });
    }
    getWithResponse(merchantCode, readerId, options) {
        return this._client.getWithResponse({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            ...options
        });
    }
    delete(merchantCode, readerId, options) {
        return this._client.delete({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            ...options
        });
    }
    deleteWithResponse(merchantCode, readerId, options) {
        return this._client.deleteWithResponse({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            ...options
        });
    }
    update(merchantCode, readerId, body, options) {
        return this._client.patch({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            body,
            ...options
    ...
    updateWithResponse(merchantCode, readerId, body, options) {
        return this._client.patchWithResponse({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}`,
            body,
            ...options
    ...
    getCheckout(merchantCode, readerId, checkoutId, options) {
        return this._client.get({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}/checkout/${checkoutId}`,
            ...options
        });
    }
    getCheckoutWithResponse(merchantCode, readerId, checkoutId, options) {
        return this._client.getWithResponse({
            path: `/v0.1/merchants/${merchantCode}/readers/${readerId}/checkout/${checkoutId}`,
            ...options
        });
...
class Receipts extends APIResource {
    get(transactionId, query, options) {
        return this._client.get({
    ...
    getWithResponse(transactionId, query, options) {
        return this._client.getWithResponse({
            path: `/v1.1/receipts/${transactionId}`,
            query,
            ...options
...
class Transactions extends APIResource {
    refund(merchantCode, transactionId, body, options) {
        return this._client.post({
    ...
    refundWithResponse(merchantCode, transactionId, body, options) {
        return this._client.postWithResponse({
            path: `/v1.0/merchants/${merchantCode}/payments/${transactionId}/refunds`,
            body,
            ...options
...
const src = SumUp;
exports.APIError = __webpack_exports__.APIError;
exports.Checkouts = __webpack_exports__.Checkouts;
exports.Customers = __webpack_exports__.Customers;
exports.Members = __webpack_exports__.Members;
exports.Memberships = __webpack_exports__.Memberships;
exports.Merchants = __webpack_exports__.Merchants;
exports.Payouts = __webpack_exports__.Payouts;
exports.Readers = __webpack_exports__.Readers;
exports.Receipts = __webpack_exports__.Receipts;
exports.Roles = __webpack_exports__.Roles;
exports.SumUp = __webpack_exports__.SumUp;
exports.SumUpError = __webpack_exports__.SumUpError;
exports.Transactions = __webpack_exports__.Transactions;
