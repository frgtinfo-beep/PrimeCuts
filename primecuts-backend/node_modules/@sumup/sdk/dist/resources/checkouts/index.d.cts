...
import type { Checkout, CheckoutCreateRequest, CheckoutSuccess, CheckoutUpdateRequest, ErrorBody } from "../../types";
...
export type CreateApplePaySessionError = ErrorBody /**
...
export declare class Checkouts extends APIResource {
     ...
     */
    listAvailablePaymentMethods(merchantCode: string, query?: GetPaymentMethodsQueryParams, options?: RequestOptions): Promise<GetPaymentMethodsResponse>;
    listAvailablePaymentMethodsWithResponse(merchantCode: string, query?: GetPaymentMethodsQueryParams, options?: RequestOptions): Promise<WithResponse<GetPaymentMethodsResponse>>;
    /**
     * Lists created checkout resources according to the applied `checkout_reference`.
     */
    list(query?: ListCheckoutsQueryParams, options?: RequestOptions): Promise<CheckoutSuccess[]>;
    listWithResponse(query?: ListCheckoutsQueryParams, options?: RequestOptions): Promise<WithResponse<CheckoutSuccess[]>>;
    /**
     ...
     */
    create(body: CheckoutCreateRequest, options?: RequestOptions): Promise<Checkout>;
    createWithResponse(body: CheckoutCreateRequest, options?: RequestOptions): Promise<WithResponse<Checkout>>;
    /**
    ...
    getWithResponse(checkoutId: string, options?: RequestOptions): Promise<WithResponse<CheckoutSuccess>>;
    /**
     * Deactivates an identified checkout resource. If the checkout has already been processed it can not be deactivated.
     */
    deactivate(checkoutId: string, options?: RequestOptions): Promise<Checkout>;
    deactivateWithResponse(checkoutId: string, options?: RequestOptions): Promise<WithResponse<Checkout>>;
    /**
     * Updates an identified checkout resource.
     */
    update(checkoutId: string, body: CheckoutUpdateRequest, options?: RequestOptions): Promise<Checkout>;
    updateWithResponse(checkoutId: string, body: CheckoutUpdateRequest, options?: RequestOptions): Promise<WithResponse<Checkout>>;
    /**
     ...
     *
     */
    createApplePaySession(checkoutId: string, body?: CreateApplePaySessionParams, options?: RequestOptions): Promise<CreateApplePaySessionResponse>;
    createApplePaySessionWithResponse(checkoutId: string, body?: CreateApplePaySessionParams, options?: RequestOptions): Promise<WithResponse<CreateApplePaySessionResponse>>;
}
