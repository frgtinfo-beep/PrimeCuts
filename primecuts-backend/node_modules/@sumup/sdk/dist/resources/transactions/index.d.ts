...
export declare class Transactions extends APIResource {
     ...
     */
    refund(merchantCode: string, transactionId: string, body?: RefundTransactionParams, options?: RequestOptions): Promise<RefundTransactionResponse>;
    refundWithResponse(merchantCode: string, transactionId: string, body?: RefundTransactionParams, options?: RequestOptions): Promise<WithResponse<RefundTransactionResponse>>;
    /**
