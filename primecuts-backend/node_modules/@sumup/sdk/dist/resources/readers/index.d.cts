...
import type { CreateReaderCheckoutRequest, CreateReaderCheckoutResponse, GetReaderCheckoutResponse, Metadata, Reader, ReaderID, ReaderName, ReaderPairingCode, ReaderPaymentRequestParams, ReaderPaymentResponse, StatusResponse } from "../../types";
...
export declare class Readers extends APIResource {
     ...
     */
    createGoCheckout(merchantCode: string, readerId: ReaderID, body: ReaderPaymentRequestParams, options?: RequestOptions): Promise<ReaderPaymentResponse>;
    createGoCheckoutWithResponse(merchantCode: string, readerId: ReaderID, body: ReaderPaymentRequestParams, options?: RequestOptions): Promise<WithResponse<ReaderPaymentResponse>>;
    /**
     ...
     * Retrieve a Reader.
     */
    get(merchantCode: string, readerId: ReaderID, options?: RequestOptions): Promise<Reader>;
    getWithResponse(merchantCode: string, readerId: ReaderID, options?: RequestOptions): Promise<WithResponse<Reader>>;
    /**
     * Delete a reader.
     */
    delete(merchantCode: string, readerId: ReaderID, options?: RequestOptions): Promise<void>;
    deleteWithResponse(merchantCode: string, readerId: ReaderID, options?: RequestOptions): Promise<WithResponse<void>>;
    /**
     * Update a Reader.
     */
    update(merchantCode: string, readerId: ReaderID, body: UpdateReaderParams, options?: RequestOptions): Promise<Reader>;
    updateWithResponse(merchantCode: string, readerId: ReaderID, body: UpdateReaderParams, options?: RequestOptions): Promise<WithResponse<Reader>>;
    /**
     ...
     *
     */
    getCheckout(merchantCode: string, readerId: string, checkoutId: string, options?: RequestOptions): Promise<GetReaderCheckoutResponse>;
    getCheckoutWithResponse(merchantCode: string, readerId: string, checkoutId: string, options?: RequestOptions): Promise<WithResponse<GetReaderCheckoutResponse>>;
}
