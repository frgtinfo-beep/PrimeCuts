 ...
 */
export declare class Receipts extends APIResource {
    /**
     * Retrieves receipt specific data for a transaction.
     */
    get(transactionId: string, query: GetReceiptQueryParams, options?: RequestOptions): Promise<Receipt>;
    getWithResponse(transactionId: string, query: GetReceiptQueryParams, options?: RequestOptions): Promise<WithResponse<Receipt>>;
}
